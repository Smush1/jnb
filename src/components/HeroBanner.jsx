                      ...
                      <div className="overlay"></div>
                          ...
                          <div className="carousel-caption">
                              ...
                              <p className="pb-2">Explore our handcrafted collection, trusted by customers across the globe. Every product is
                                  ...
                                  on <a href="https://www.indusmela.com" target="_blank" rel="noreferrer"  className="hero-banner-link">Indusmela.com</a>, <a href="https://www.indusmela.in" target="_blank" rel="noreferrer"  className="hero-banner-link">Indusmela.in</a> and <a href="https://www.amazon.in/stores/JnB/page/4619FB37-DF68-4B82-8D4E-E8177DFB2979?lp_asin=B0CSSM6LH7&ref_=ast_bln" target="_blank" rel="noreferrer"  className="hero-banner-link">Amazon</a> ensuring premium quality, fair pricing, and reliable delivery. Our mission is to bring the warmth of Indian artistry into homes worldwide.</p>
